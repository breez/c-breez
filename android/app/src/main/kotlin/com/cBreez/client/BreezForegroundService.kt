...
class BreezForegroundService : ForegroundService() {
    companion object {
        ...
        private const val kAutoChannelSetupFeeLimit =
            "payment_options_auto_channel_setup_fee_limit"
    ...
    override fun getServiceConfig(): ServiceConfig? {
        return try {
            ...
            val autoChannelSetupFeeLimitMsats =
                sharedPreferences.getInt(kAutoChannelSetupFeeLimit, 0).toULong()
            val serviceConfig =
                ServiceConfig(autoChannelSetupFeeLimitMsats = autoChannelSetupFeeLimitMsats)
