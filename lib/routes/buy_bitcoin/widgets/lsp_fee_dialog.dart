...
Future<bool?> promptLSPFeeAndNavigate(
...
String formatFeeMessage(BuildContext context, OpeningFeeParams openingFeeParams) {
  ...
  if (minFeeAboveZero && liquidityAboveZero) {
    ...
    return texts.moonpay_fee_warning_without_min_fee_account_connected(
      setUpFee,
      liquidity,
    );
  } else if (minFeeAboveZero && !liquidityAboveZero) {
    ...
    return texts.moonpay_fee_warning_without_min_fee_account_not_connected(
      setUpFee,
    );
  }
}
