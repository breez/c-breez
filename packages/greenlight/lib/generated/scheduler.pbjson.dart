...
final $typed_data.Uint8List challengeScopeDescriptor = $convert.base64Decode('Cg5DaGFsbGVuZ2VTY29wZRIMCghSRUdJU1RFUhAAEgsKB1JFQ09WRVIQAQ==');
@$core.Deprecated('Use challengeRequestDescriptor instead')
const ChallengeRequest$json = const {
  '1': 'ChallengeRequest',
  '2': const [
    const {'1': 'scope', '3': 1, '4': 1, '5': 14, '6': '.scheduler.ChallengeScope', '10': 'scope'},
    const {'1': 'node_id', '3': 2, '4': 1, '5': 12, '10': 'nodeId'},
  ],
};

/// Descriptor for `ChallengeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List challengeRequestDescriptor = $convert.base64Decode('ChBDaGFsbGVuZ2VSZXF1ZXN0Ei8KBXNjb3BlGAEgASgOMhkuc2NoZWR1bGVyLkNoYWxsZW5nZVNjb3BlUgVzY29wZRIXCgdub2RlX2lkGAIgASgMUgZub2RlSWQ=');
...
final $typed_data.Uint8List challengeResponseDescriptor = $convert.base64Decode('ChFDaGFsbGVuZ2VSZXNwb25zZRIcCgljaGFsbGVuZ2UYASABKAxSCWNoYWxsZW5nZQ==');
...
const RegistrationRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'init_msg', '3': 8, '4': 1, '5': 12, '9': 0, '10': 'initMsg', '17': true},
  ],
  '8': const [
    const {'1': '_init_msg'},
  ],
...
final $typed_data.Uint8List registrationRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List registrationResponseDescriptor = $convert.base64Decode('ChRSZWdpc3RyYXRpb25SZXNwb25zZRIfCgtkZXZpY2VfY2VydBgBIAEoCVIKZGV2aWNlQ2VydBIdCgpkZXZpY2Vfa2V5GAIgASgJUglkZXZpY2VLZXk=');
...
final $typed_data.Uint8List scheduleRequestDescriptor = $convert.base64Decode('Cg9TY2hlZHVsZVJlcXVlc3QSFwoHbm9kZV9pZBgBIAEoDFIGbm9kZUlk');
...
final $typed_data.Uint8List nodeInfoRequestDescriptor = $convert.base64Decode('Cg9Ob2RlSW5mb1JlcXVlc3QSFwoHbm9kZV9pZBgBIAEoDFIGbm9kZUlkEhIKBHdhaXQYAiABKAhSBHdhaXQ=');
...
final $typed_data.Uint8List nodeInfoResponseDescriptor = $convert.base64Decode('ChBOb2RlSW5mb1Jlc3BvbnNlEhcKB25vZGVfaWQYASABKAxSBm5vZGVJZBIZCghncnBjX3VyaRgCIAEoCVIHZ3JwY1VyaQ==');
...
final $typed_data.Uint8List recoveryRequestDescriptor = $convert.base64Decode('Cg9SZWNvdmVyeVJlcXVlc3QSHAoJY2hhbGxlbmdlGAEgASgMUgljaGFsbGVuZ2USHAoJc2lnbmF0dXJlGAIgASgMUglzaWduYXR1cmUSFwoHbm9kZV9pZBgDIAEoDFIGbm9kZUlk');
...
final $typed_data.Uint8List recoveryResponseDescriptor = $convert.base64Decode('ChBSZWNvdmVyeVJlc3BvbnNlEh8KC2RldmljZV9jZXJ0GAEgASgJUgpkZXZpY2VDZXJ0Eh0KCmRldmljZV9rZXkYAiABKAlSCWRldmljZUtleQ==');
@$core.Deprecated('Use upgradeRequestDescriptor instead')
const UpgradeRequest$json = const {
  '1': 'UpgradeRequest',
  '2': const [
    const {'1': 'signer_version', '3': 1, '4': 1, '5': 9, '10': 'signerVersion'},
    const {'1': 'initmsg', '3': 2, '4': 1, '5': 12, '10': 'initmsg'},
  ],
};

/// Descriptor for `UpgradeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List upgradeRequestDescriptor = $convert.base64Decode('Cg5VcGdyYWRlUmVxdWVzdBIlCg5zaWduZXJfdmVyc2lvbhgBIAEoCVINc2lnbmVyVmVyc2lvbhIYCgdpbml0bXNnGAIgASgMUgdpbml0bXNn');
...
final $typed_data.Uint8List upgradeResponseDescriptor = $convert.base64Decode('Cg9VcGdyYWRlUmVzcG9uc2USHwoLb2xkX3ZlcnNpb24YASABKAlSCm9sZFZlcnNpb24=');
