...
class PaymentInformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentInformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'breez'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentHash', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentSecret', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destination', $pb.PbFieldType.OY)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'incomingAmountMsat')
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outgoingAmountMsat')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$core.int> get paymentSecret => $_getN(1);
  @$pb.TagNumber(2)
  set paymentSecret($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasPaymentSecret() => $_has(1);
  @$pb.TagNumber(2)
  void clearPaymentSecret() => clearField(2);
  ...
  @$pb.TagNumber(4)
  $fixnum.Int64 get incomingAmountMsat => $_getI64(3);
  @$pb.TagNumber(4)
  set incomingAmountMsat($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasIncomingAmountMsat() => $_has(3);
  @$pb.TagNumber(4)
  void clearIncomingAmountMsat() => clearField(4);

  @$pb.TagNumber(5)
  $fixnum.Int64 get outgoingAmountMsat => $_getI64(4);
  @$pb.TagNumber(5)
  set outgoingAmountMsat($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasOutgoingAmountMsat() => $_has(4);
  @$pb.TagNumber(5)
  void clearOutgoingAmountMsat() => clearField(5);
}
