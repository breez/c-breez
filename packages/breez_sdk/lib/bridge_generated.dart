...
class LightningToolkitImpl extends FlutterRustBridgeBase<LightningToolkitWire>
  ...
  Future<GreenlightCredentials> registerNode(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_register_node(
            port_, _api2wire_network(network), _api2wire_uint_8_list(seed)),
  ...
  Future<GreenlightCredentials> recoverNode(
          {required Network network, required Uint8List seed, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_recover_node(
            port_, _api2wire_network(network), _api2wire_uint_8_list(seed)),
        parseSuccessData: _wire2api_greenlight_credentials,
  ...
  Future<void> createNodeServices(
          ...
          dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_create_node_services(
            port_,
            _api2wire_box_autoadd_config(breezConfig),
            _api2wire_uint_8_list(seed),
            _api2wire_box_autoadd_greenlight_credentials(creds)),
  ...
  Future<void> startNode({dynamic hint}) => executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_start_node(port_),
        parseSuccessData: _wire2api_unit,
  ...
  Future<void> runSigner({dynamic hint}) => executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_run_signer(port_),
        parseSuccessData: _wire2api_unit,
  ...
  Future<void> stopSigner({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_stop_signer(port_),
        parseSuccessData: _wire2api_unit,
  ...
  Future<void> sync({dynamic hint}) => executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_sync(port_),
        parseSuccessData: _wire2api_unit,
  ...
  Future<List<LspInformation>> listLsps({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_list_lsps(port_),
  ...
  Future<void> setLspId({required String lspId, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) =>
            inner.wire_set_lsp_id(port_, _api2wire_String(lspId)),
        parseSuccessData: _wire2api_unit,
  ...
  Future<NodeState?> getNodeState({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_get_node_state(port_),
  ...
  Future<List<Rate>> fetchRates({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_fetch_rates(port_),
  ...
  Future<List<FiatCurrency>> listFiatCurrencies({dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_list_fiat_currencies(port_),
  ...
  Future<List<LightningTransaction>> listTransactions(
          ...
          dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_list_transactions(
            port_,
            _api2wire_payment_type_filter(filter),
            _api2wire_opt_box_autoadd_i64(fromTimestamp),
            _api2wire_opt_box_autoadd_i64(toTimestamp)),
  ...
  Future<void> keysend(
          {required String nodeId, required int amountSats, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_keysend(
            port_, _api2wire_String(nodeId), _api2wire_u64(amountSats)),
        parseSuccessData: _wire2api_unit,
  ...
  Future<LNInvoice> requestPayment(
          ...
          dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_request_payment(
            port_, _api2wire_u64(amountSats), _api2wire_String(description)),
  ...
  ffi.Pointer<wire_GreenlightCredentials>
      _api2wire_box_autoadd_greenlight_credentials(GreenlightCredentials raw) {
  ...
  int _api2wire_payment_type_filter(PaymentTypeFilter raw) {
    return _api2wire_i32(raw.index);
  }
  ...
  void _api_fill_to_wire_config(Config apiObj, wire_Config wireObj) {
    wireObj.breezserver = _api2wire_String(apiObj.breezserver);
    wireObj.mempoolspace_url = _api2wire_String(apiObj.mempoolspaceUrl);
    wireObj.working_dir = _api2wire_String(apiObj.workingDir);
    wireObj.network = _api2wire_network(apiObj.network);
    wireObj.payment_timeout_sec = _api2wire_u32(apiObj.paymentTimeoutSec);
  }

  void _api_fill_to_wire_greenlight_credentials(
      GreenlightCredentials apiObj, wire_GreenlightCredentials wireObj) {
    wireObj.device_key = _api2wire_uint_8_list(apiObj.deviceKey);
    wireObj.device_cert = _api2wire_uint_8_list(apiObj.deviceCert);
  }
}
