...
class ChallengeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<ChallengeScope>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'scope',
        $pb.PbFieldType.OE,
        defaultOrMaker: ChallengeScope.REGISTER,
        valueOf: ChallengeScope.valueOf,
        enumValues: ChallengeScope.values)
  ...
  factory ChallengeRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ChallengeRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  ChallengeRequest copyWith(void Function(ChallengeRequest) updates) =>
      super.copyWith((message) => updates(message as ChallengeRequest))
          as ChallengeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ChallengeRequest create() => ChallengeRequest._();
  ChallengeRequest createEmptyInstance() => create();
  static $pb.PbList<ChallengeRequest> createRepeated() =>
      $pb.PbList<ChallengeRequest>();
  @$core.pragma('dart2js:noInline')
  static ChallengeRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ChallengeRequest>(create);
  static ChallengeRequest? _defaultInstance;

  @$pb.TagNumber(1)
  ChallengeScope get scope => $_getN(0);
  @$pb.TagNumber(1)
  set scope(ChallengeScope v) {
    setField(1, v);
  }
...
class ChallengeResponse extends $pb.GeneratedMessage {
  ...
  factory ChallengeResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ChallengeResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ChallengeResponse copyWith(void Function(ChallengeResponse) updates) =>
      super.copyWith((message) => updates(message as ChallengeResponse))
          as ChallengeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegistrationRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set bip32Key($core.List<$core.int> v) {
    $_setBytes(1, v);
  }
...
class ScheduleRequest extends $pb.GeneratedMessage {
  ...
  factory ScheduleRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ScheduleRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ScheduleRequest copyWith(void Function(ScheduleRequest) updates) =>
      super.copyWith((message) => updates(message as ScheduleRequest))
          as ScheduleRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ScheduleRequest create() => ScheduleRequest._();
  ScheduleRequest createEmptyInstance() => create();
  static $pb.PbList<ScheduleRequest> createRepeated() =>
      $pb.PbList<ScheduleRequest>();
  @$core.pragma('dart2js:noInline')
...
class NodeInfoRequest extends $pb.GeneratedMessage {
  ...
  NodeInfoRequest copyWith(void Function(NodeInfoRequest) updates) =>
      super.copyWith((message) => updates(message as NodeInfoRequest))
          as NodeInfoRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NodeInfoResponse extends $pb.GeneratedMessage {
  ...
  factory NodeInfoResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory NodeInfoResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  NodeInfoResponse copyWith(void Function(NodeInfoResponse) updates) =>
      super.copyWith((message) => updates(message as NodeInfoResponse))
          as NodeInfoResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NodeInfoResponse create() => NodeInfoResponse._();
  NodeInfoResponse createEmptyInstance() => create();
  static $pb.PbList<NodeInfoResponse> createRepeated() =>
      $pb.PbList<NodeInfoResponse>();
  @$core.pragma('dart2js:noInline')
...
class RecoveryRequest extends $pb.GeneratedMessage {
  ...
  factory RecoveryRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RecoveryRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  RecoveryRequest copyWith(void Function(RecoveryRequest) updates) =>
      super.copyWith((message) => updates(message as RecoveryRequest))
          as RecoveryRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RecoveryRequest create() => RecoveryRequest._();
  RecoveryRequest createEmptyInstance() => create();
  static $pb.PbList<RecoveryRequest> createRepeated() =>
      $pb.PbList<RecoveryRequest>();
  @$core.pragma('dart2js:noInline')
...
class RecoveryResponse extends $pb.GeneratedMessage {
  ...
  factory RecoveryResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RecoveryResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RecoveryResponse copyWith(void Function(RecoveryResponse) updates) =>
      super.copyWith((message) => updates(message as RecoveryResponse))
          as RecoveryResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RecoveryResponse create() => RecoveryResponse._();
  RecoveryResponse createEmptyInstance() => create();
  static $pb.PbList<RecoveryResponse> createRepeated() =>
      $pb.PbList<RecoveryResponse>();
  @$core.pragma('dart2js:noInline')
  static RecoveryResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RecoveryResponse>(create);
...
class UpgradeRequest extends $pb.GeneratedMessage {
  ...
  UpgradeRequest copyWith(void Function(UpgradeRequest) updates) =>
      super.copyWith((message) => updates(message as UpgradeRequest))
          as UpgradeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set signerVersion($core.String v) {
    $_setString(0, v);
  }
...
class UpgradeResponse extends $pb.GeneratedMessage {
  ...
  UpgradeResponse copyWith(void Function(UpgradeResponse) updates) =>
      super.copyWith((message) => updates(message as UpgradeResponse))
          as UpgradeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
