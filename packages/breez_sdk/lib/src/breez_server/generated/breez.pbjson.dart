...
const PaymentInformation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'payment_secret', '3': 2, '4': 1, '5': 12, '10': 'paymentSecret'},
    const {'1': 'destination', '3': 3, '4': 1, '5': 12, '10': 'destination'},
    const {'1': 'incoming_amount_msat', '3': 4, '4': 1, '5': 3, '10': 'incomingAmountMsat'},
    const {'1': 'outgoing_amount_msat', '3': 5, '4': 1, '5': 3, '10': 'outgoingAmountMsat'},
  ],
};

/// Descriptor for `PaymentInformation`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List paymentInformationDescriptor = $convert.base64Decode('');
