...
final $typed_data.Uint8List netAddressTypeDescriptor = $convert.base64Decode(
    'Cg5OZXRBZGRyZXNzVHlwZRIICgRJcHY0EAASCAoESXB2NhABEgkKBVRvclYyEAISCQoFVG9yVjMQAw==');
...
final $typed_data.Uint8List btcAddressTypeDescriptor = $convert.base64Decode(
    'Cg5CdGNBZGRyZXNzVHlwZRIKCgZCRUNIMzIQABIPCgtQMlNIX1NFR1dJVBAB');
...
final $typed_data.Uint8List outputStatusDescriptor = $convert.base64Decode(
    'CgxPdXRwdXRTdGF0dXMSDQoJQ09ORklSTUVEEAASDwoLVU5DT05GSVJNRUQQAQ==');
...
final $typed_data.Uint8List feeratePresetDescriptor = $convert.base64Decode(
    'Cg1GZWVyYXRlUHJlc2V0EgoKBk5PUk1BTBAAEggKBFNMT1cQARIKCgZVUkdFTlQQAg==');
...
final $typed_data.Uint8List closeChannelTypeDescriptor = $convert.base64Decode(
    'ChBDbG9zZUNoYW5uZWxUeXBlEgoKBk1VVFVBTBAAEg4KClVOSUxBVEVSQUwQAQ==');
...
final $typed_data.Uint8List invoiceStatusDescriptor = $convert.base64Decode(
    'Cg1JbnZvaWNlU3RhdHVzEgoKBlVOUEFJRBAAEggKBFBBSUQQARILCgdFWFBJUkVEEAI=');
...
final $typed_data.Uint8List payStatusDescriptor = $convert.base64Decode(
    'CglQYXlTdGF0dXMSCwoHUEVORElORxAAEgwKCENPTVBMRVRFEAESCgoGRkFJTEVEEAI=');
...
final $typed_data.Uint8List hsmRequestContextDescriptor = $convert.base64Decode(
    'ChFIc21SZXF1ZXN0Q29udGV4dBIXCgdub2RlX2lkGAEgASgMUgZub2RlSWQSEgoEZGJpZBgCIAEoBFIEZGJpZBIiCgxjYXBhYmlsaXRpZXMYAyABKARSDGNhcGFiaWxpdGllcw==');
...
final $typed_data.Uint8List hsmResponseDescriptor = $convert.base64Decode(
    'CgtIc21SZXNwb25zZRIdCgpyZXF1ZXN0X2lkGAEgASgNUglyZXF1ZXN0SWQSEAoDcmF3GAIgASgMUgNyYXc=');
...
const HsmRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.greenlight.HsmRequestContext',
      '10': 'context'
    },
...
final $typed_data.Uint8List hsmRequestDescriptor = $convert.base64Decode(
    'CgpIc21SZXF1ZXN0Eh0KCnJlcXVlc3RfaWQYASABKA1SCXJlcXVlc3RJZBI3Cgdjb250ZXh0GAIgASgLMh0uZ3JlZW5saWdodC5Ic21SZXF1ZXN0Q29udGV4dFIHY29udGV4dBIQCgNyYXcYAyABKAxSA3Jhdw==');
...
final $typed_data.Uint8List addressDescriptor = $convert.base64Decode(
    'CgdBZGRyZXNzEi4KBHR5cGUYASABKA4yGi5ncmVlbmxpZ2h0Lk5ldEFkZHJlc3NUeXBlUgR0eXBlEhIKBGFkZHIYAiABKAlSBGFkZHISEgoEcG9ydBgDIAEoDVIEcG9ydA==');
...
final $typed_data.Uint8List getInfoResponseDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List connectRequestDescriptor = $convert.base64Decode(
    'Cg5Db25uZWN0UmVxdWVzdBIXCgdub2RlX2lkGAEgASgJUgZub2RlSWQSEgoEYWRkchgCIAEoCVIEYWRkcg==');
...
final $typed_data.Uint8List connectResponseDescriptor = $convert.base64Decode(
    'Cg9Db25uZWN0UmVzcG9uc2USFwoHbm9kZV9pZBgBIAEoCVIGbm9kZUlkEhoKCGZlYXR1cmVzGAIgASgJUghmZWF0dXJlcw==');
...
final $typed_data.Uint8List listPeersRequestDescriptor = $convert.base64Decode(
    'ChBMaXN0UGVlcnNSZXF1ZXN0EhcKB25vZGVfaWQYASABKAlSBm5vZGVJZA==');
...
final $typed_data.Uint8List htlcDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List channelDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List peerDescriptor = $convert.base64Decode(
    'CgRQZWVyEg4KAmlkGAEgASgMUgJpZBIcCgljb25uZWN0ZWQYAiABKAhSCWNvbm5lY3RlZBIxCglhZGRyZXNzZXMYAyADKAsyEy5ncmVlbmxpZ2h0LkFkZHJlc3NSCWFkZHJlc3NlcxIaCghmZWF0dXJlcxgEIAEoCVIIZmVhdHVyZXMSLwoIY2hhbm5lbHMYBSADKAsyEy5ncmVlbmxpZ2h0LkNoYW5uZWxSCGNoYW5uZWxz');
...
final $typed_data.Uint8List listPeersResponseDescriptor = $convert.base64Decode(
    'ChFMaXN0UGVlcnNSZXNwb25zZRImCgVwZWVycxgBIAMoCzIQLmdyZWVubGlnaHQuUGVlclIFcGVlcnM=');
...
final $typed_data.Uint8List disconnectRequestDescriptor = $convert.base64Decode(
    'ChFEaXNjb25uZWN0UmVxdWVzdBIXCgdub2RlX2lkGAEgASgJUgZub2RlSWQSFAoFZm9yY2UYAiABKAhSBWZvcmNl');
...
final $typed_data.Uint8List newAddrRequestDescriptor = $convert.base64Decode(
    'Cg5OZXdBZGRyUmVxdWVzdBI9CgxhZGRyZXNzX3R5cGUYASABKA4yGi5ncmVlbmxpZ2h0LkJ0Y0FkZHJlc3NUeXBlUgthZGRyZXNzVHlwZQ==');
...
final $typed_data.Uint8List newAddrResponseDescriptor = $convert.base64Decode(
    'Cg9OZXdBZGRyUmVzcG9uc2USPQoMYWRkcmVzc190eXBlGAEgASgOMhouZ3JlZW5saWdodC5CdGNBZGRyZXNzVHlwZVILYWRkcmVzc1R5cGUSGAoHYWRkcmVzcxgCIAEoCVIHYWRkcmVzcw==');
...
final $typed_data.Uint8List listFundsRequestDescriptor = $convert.base64Decode(
    'ChBMaXN0RnVuZHNSZXF1ZXN0EjIKB21pbmNvbmYYASABKAsyGC5ncmVlbmxpZ2h0LkNvbmZpcm1hdGlvblIHbWluY29uZg==');
...
final $typed_data.Uint8List listFundsOutputDescriptor = $convert.base64Decode(
    'Cg9MaXN0RnVuZHNPdXRwdXQSLAoGb3V0cHV0GAEgASgLMhQuZ3JlZW5saWdodC5PdXRwb2ludFIGb3V0cHV0EioKBmFtb3VudBgCIAEoCzISLmdyZWVubGlnaHQuQW1vdW50UgZhbW91bnQSGAoHYWRkcmVzcxgEIAEoCVIHYWRkcmVzcxIwCgZzdGF0dXMYBSABKA4yGC5ncmVlbmxpZ2h0Lk91dHB1dFN0YXR1c1IGc3RhdHVz');
...
final $typed_data.Uint8List listFundsChannelDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List listFundsResponseDescriptor = $convert.base64Decode(
    'ChFMaXN0RnVuZHNSZXNwb25zZRI1CgdvdXRwdXRzGAEgAygLMhsuZ3JlZW5saWdodC5MaXN0RnVuZHNPdXRwdXRSB291dHB1dHMSOAoIY2hhbm5lbHMYAiADKAsyHC5ncmVlbmxpZ2h0Lkxpc3RGdW5kc0NoYW5uZWxSCGNoYW5uZWxz');
...
final $typed_data.Uint8List feerateDescriptor = $convert.base64Decode(
    'CgdGZWVyYXRlEjMKBnByZXNldBgBIAEoDjIZLmdyZWVubGlnaHQuRmVlcmF0ZVByZXNldEgAUgZwcmVzZXQSFgoFcGVya3cYBSABKARIAFIFcGVya3cSFgoFcGVya2IYBiABKARIAFIFcGVya2JCBwoFdmFsdWU=');
...
final $typed_data.Uint8List confirmationDescriptor = $convert
    .base64Decode('CgxDb25maXJtYXRpb24SFgoGYmxvY2tzGAEgASgNUgZibG9ja3M=');
...
final $typed_data.Uint8List withdrawRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List withdrawResponseDescriptor = $convert.base64Decode(
    'ChBXaXRoZHJhd1Jlc3BvbnNlEg4KAnR4GAEgASgMUgJ0eBISCgR0eGlkGAIgASgMUgR0eGlk');
...
final $typed_data.Uint8List fundChannelRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List fundChannelResponseDescriptor = $convert.base64Decode(
    'ChNGdW5kQ2hhbm5lbFJlc3BvbnNlEg4KAnR4GAEgASgMUgJ0eBIwCghvdXRwb2ludBgCIAEoCzIULmdyZWVubGlnaHQuT3V0cG9pbnRSCG91dHBvaW50Eh0KCmNoYW5uZWxfaWQYAyABKAxSCWNoYW5uZWxJZBIZCghjbG9zZV90bxgEIAEoCVIHY2xvc2VUbw==');
...
final $typed_data.Uint8List timeoutDescriptor =
    $convert.base64Decode('CgdUaW1lb3V0EhgKB3NlY29uZHMYASABKA1SB3NlY29uZHM=');
...
final $typed_data.Uint8List bitcoinAddressDescriptor = $convert
    .base64Decode('Cg5CaXRjb2luQWRkcmVzcxIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNz');
...
final $typed_data.Uint8List closeChannelRequestDescriptor = $convert.base64Decode(
    'ChNDbG9zZUNoYW5uZWxSZXF1ZXN0EhcKB25vZGVfaWQYASABKAxSBm5vZGVJZBJBChF1bmlsYXRlcmFsdGltZW91dBgCIAEoCzITLmdyZWVubGlnaHQuVGltZW91dFIRdW5pbGF0ZXJhbHRpbWVvdXQSPAoLZGVzdGluYXRpb24YAyABKAsyGi5ncmVlbmxpZ2h0LkJpdGNvaW5BZGRyZXNzUgtkZXN0aW5hdGlvbg==');
...
final $typed_data.Uint8List closeChannelResponseDescriptor = $convert.base64Decode(
    'ChRDbG9zZUNoYW5uZWxSZXNwb25zZRI7CgpjbG9zZV90eXBlGAEgASgOMhwuZ3JlZW5saWdodC5DbG9zZUNoYW5uZWxUeXBlUgljbG9zZVR5cGUSDgoCdHgYAiABKAxSAnR4EhIKBHR4aWQYAyABKAxSBHR4aWQ=');
...
final $typed_data.Uint8List amountDescriptor = $convert.base64Decode(
    'CgZBbW91bnQSJAoMbWlsbGlzYXRvc2hpGAEgASgESABSDG1pbGxpc2F0b3NoaRIaCgdzYXRvc2hpGAIgASgESABSB3NhdG9zaGkSGgoHYml0Y29pbhgDIAEoBEgAUgdiaXRjb2luEhIKA2FsbBgEIAEoCEgAUgNhbGwSEgoDYW55GAUgASgISABSA2FueUIGCgR1bml0');
...
final $typed_data.Uint8List invoiceRequestDescriptor = $convert.base64Decode(
    'Cg5JbnZvaWNlUmVxdWVzdBIqCgZhbW91bnQYASABKAsyEi5ncmVlbmxpZ2h0LkFtb3VudFIGYW1vdW50EhQKBWxhYmVsGAIgASgJUgVsYWJlbBIgCgtkZXNjcmlwdGlvbhgDIAEoCVILZGVzY3JpcHRpb24=');
...
final $typed_data.Uint8List invoiceDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List payRequestDescriptor = $convert.base64Decode(
    'CgpQYXlSZXF1ZXN0EhYKBmJvbHQxMRgBIAEoCVIGYm9sdDExEioKBmFtb3VudBgCIAEoCzISLmdyZWVubGlnaHQuQW1vdW50UgZhbW91bnQSGAoHdGltZW91dBgDIAEoDVIHdGltZW91dA==');
...
final $typed_data.Uint8List paymentDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List paymentIdentifierDescriptor = $convert.base64Decode(
    'ChFQYXltZW50SWRlbnRpZmllchIYCgZib2x0MTEYASABKAlIAFIGYm9sdDExEiMKDHBheW1lbnRfaGFzaBgCIAEoDEgAUgtwYXltZW50SGFzaEIECgJpZA==');
...
const ListPaymentsRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.greenlight.PaymentIdentifier',
      '10': 'identifier'
    },
  ],
};
...
final $typed_data.Uint8List listPaymentsRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0UGF5bWVudHNSZXF1ZXN0Ej0KCmlkZW50aWZpZXIYASABKAsyHS5ncmVlbmxpZ2h0LlBheW1lbnRJZGVudGlmaWVyUgppZGVudGlmaWVy');
...
final $typed_data.Uint8List listPaymentsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0UGF5bWVudHNSZXNwb25zZRIvCghwYXltZW50cxgBIAMoCzITLmdyZWVubGlnaHQuUGF5bWVudFIIcGF5bWVudHM=');
...
final $typed_data.Uint8List invoiceIdentifierDescriptor = $convert.base64Decode(
    'ChFJbnZvaWNlSWRlbnRpZmllchIWCgVsYWJlbBgBIAEoCUgAUgVsYWJlbBIeCglpbnZzdHJpbmcYAiABKAlIAFIJaW52c3RyaW5nEiMKDHBheW1lbnRfaGFzaBgDIAEoDEgAUgtwYXltZW50SGFzaEIECgJpZA==');
...
const ListInvoicesRequest$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.greenlight.InvoiceIdentifier',
      '10': 'identifier'
    },
  ],
};
...
final $typed_data.Uint8List listInvoicesRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0SW52b2ljZXNSZXF1ZXN0Ej0KCmlkZW50aWZpZXIYASABKAsyHS5ncmVlbmxpZ2h0Lkludm9pY2VJZGVudGlmaWVyUgppZGVudGlmaWVy');
...
final $typed_data.Uint8List streamIncomingFilterDescriptor =
    $convert.base64Decode('ChRTdHJlYW1JbmNvbWluZ0ZpbHRlcg==');
...
final $typed_data.Uint8List listInvoicesResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0SW52b2ljZXNSZXNwb25zZRIvCghpbnZvaWNlcxgBIAMoCzITLmdyZWVubGlnaHQuSW52b2ljZVIIaW52b2ljZXM=');
...
final $typed_data.Uint8List tlvFieldDescriptor = $convert.base64Decode(
    'CghUbHZGaWVsZBISCgR0eXBlGAEgASgEUgR0eXBlEhQKBXZhbHVlGAIgASgMUgV2YWx1ZQ==');
...
final $typed_data.Uint8List offChainPaymentDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List incomingPaymentDescriptor = $convert.base64Decode(
    'Cg9JbmNvbWluZ1BheW1lbnQSOQoIb2ZmY2hhaW4YASABKAsyGy5ncmVlbmxpZ2h0Lk9mZkNoYWluUGF5bWVudEgAUghvZmZjaGFpbkIJCgdkZXRhaWxz');
...
final $typed_data.Uint8List routehintHopDescriptor = $convert.base64Decode(
    'CgxSb3V0ZWhpbnRIb3ASFwoHbm9kZV9pZBgBIAEoDFIGbm9kZUlkEigKEHNob3J0X2NoYW5uZWxfaWQYAiABKAlSDnNob3J0Q2hhbm5lbElkEhkKCGZlZV9iYXNlGAMgASgEUgdmZWVCYXNlEhkKCGZlZV9wcm9wGAQgASgNUgdmZWVQcm9wEioKEWNsdHZfZXhwaXJ5X2RlbHRhGAUgASgNUg9jbHR2RXhwaXJ5RGVsdGE=');
...
final $typed_data.Uint8List routehintDescriptor = $convert.base64Decode(
    'CglSb3V0ZWhpbnQSLAoEaG9wcxgBIAMoCzIYLmdyZWVubGlnaHQuUm91dGVoaW50SG9wUgRob3Bz');
...
final $typed_data.Uint8List keysendRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List streamLogRequestDescriptor =
    $convert.base64Decode('ChBTdHJlYW1Mb2dSZXF1ZXN0');
...
final $typed_data.Uint8List logEntryDescriptor =
    $convert.base64Decode('CghMb2dFbnRyeRISCgRsaW5lGAEgASgJUgRsaW5l');
