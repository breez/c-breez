...
final $typed_data.Uint8List ratesRequestDescriptor =
    $convert.base64Decode('CgxSYXRlc1JlcXVlc3Q=');
...
final $typed_data.Uint8List lSPListRequestDescriptor = $convert
    .base64Decode('Cg5MU1BMaXN0UmVxdWVzdBIWCgZwdWJrZXkYAiABKAlSBnB1YmtleQ==');
...
final $typed_data.Uint8List lSPInformationDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List registerPaymentRequestDescriptor =
...
final $typed_data.Uint8List checkChannelsRequestDescriptor = $convert.base64Decode(
    'ChRDaGVja0NoYW5uZWxzUmVxdWVzdBIVCgZsc3BfaWQYASABKAlSBWxzcElkEhIKBGJsb2IYAiABKAxSBGJsb2I=');
...
final $typed_data.Uint8List checkChannelsReplyDescriptor = $convert
    .base64Decode('ChJDaGVja0NoYW5uZWxzUmVwbHkSEgoEYmxvYhgCIAEoDFIEYmxvYg==');
...
final $typed_data.Uint8List openLSPChannelRequestDescriptor = $convert.base64Decode(
    'ChVPcGVuTFNQQ2hhbm5lbFJlcXVlc3QSFQoGbHNwX2lkGAEgASgJUgVsc3BJZBIWCgZwdWJrZXkYAiABKAlSBnB1YmtleQ==');
...
final $typed_data.Uint8List openLSPChannelReplyDescriptor =
    $convert.base64Decode('ChNPcGVuTFNQQ2hhbm5lbFJlcGx5');
...
final $typed_data.Uint8List openChannelRequestDescriptor = $convert.base64Decode(
    'ChJPcGVuQ2hhbm5lbFJlcXVlc3QSFgoGcHViS2V5GAEgASgJUgZwdWJLZXkSLAoRbm90aWZpY2F0aW9uVG9rZW4YAiABKAlSEW5vdGlmaWNhdGlvblRva2Vu');
...
final $typed_data.Uint8List openChannelReplyDescriptor =
    $convert.base64Decode('ChBPcGVuQ2hhbm5lbFJlcGx5');
...
final $typed_data.Uint8List openPublicChannelRequestDescriptor =
    $convert.base64Decode(
        'ChhPcGVuUHVibGljQ2hhbm5lbFJlcXVlc3QSFgoGcHVia2V5GAEgASgJUgZwdWJrZXk=');
...
final $typed_data.Uint8List openPublicChannelReplyDescriptor =
    $convert.base64Decode('ChZPcGVuUHVibGljQ2hhbm5lbFJlcGx5');
...
final $typed_data.Uint8List redeemRemovedFundsRequestDescriptor =
    $convert.base64Decode(
        'ChlSZWRlZW1SZW1vdmVkRnVuZHNSZXF1ZXN0EiAKC3BheW1lbnRoYXNoGAEgASgJUgtwYXltZW50aGFzaA==');
...
final $typed_data.Uint8List getSwapPaymentRequestDescriptor = $convert.base64Decode(
    'ChVHZXRTd2FwUGF5bWVudFJlcXVlc3QSJgoOcGF5bWVudFJlcXVlc3QYASABKAlSDnBheW1lbnRSZXF1ZXN0');
...
final $typed_data.Uint8List redeemSwapPaymentRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List registerReplyDescriptor = $convert
    .base64Decode('Cg1SZWdpc3RlclJlcGx5EhgKB2JyZWV6SUQYASABKAlSB2JyZWV6SUQ=');
...
final $typed_data.Uint8List pingReplyDescriptor = $convert
    .base64Decode('CglQaW5nUmVwbHkSGAoHdmVyc2lvbhgBIAEoCVIHdmVyc2lvbg==');
...
final $typed_data.Uint8List orderReplyDescriptor =
    $convert.base64Decode('CgpPcmRlclJlcGx5');
...
final $typed_data.Uint8List getNodeInfoRequestDescriptor = $convert.base64Decode(
    'ChJHZXROb2RlSW5mb1JlcXVlc3QSFgoGcHVia2V5GAEgASgMUgZwdWJrZXkSEAoDa2V5GAIgASgJUgNrZXk=');
...
final $typed_data.Uint8List joinCTPSessionResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List terminateCTPSessionRequestDescriptor =
    $convert.base64Decode(
        'ChpUZXJtaW5hdGVDVFBTZXNzaW9uUmVxdWVzdBIcCglzZXNzaW9uSUQYASABKAlSCXNlc3Npb25JRA==');
...
@$core
    .Deprecated('Use registerTransactionConfirmationRequestDescriptor instead')
...
@$core
    .Deprecated('Use registerTransactionConfirmationResponseDescriptor instead')
...
final $typed_data.Uint8List registerPeriodicSyncRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List boltzReverseSwapLockupTxDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List pushTxNotificationRequestDescriptor =
    $convert.base64Decode(
