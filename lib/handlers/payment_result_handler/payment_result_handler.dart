...
class PaymentResultHandler extends Handler {
  ...
  PaymentResultHandler({this.breezPreferences = const BreezPreferences()});
  ...
  void _reportFlow(String paymentHash, String comment) async {
    ...
    final behavior = await breezPreferences.getBugReportBehavior();
    switch (behavior) {
      ...
      default:
        ...
        if (result is PaymentFailedReportDialogResult) {
          ...
          if (result.doNotAskAgain) {
            await breezPreferences.setBugReportBehavior(
