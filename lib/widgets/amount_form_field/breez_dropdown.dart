...
class BreezDropdownButtonState<T> extends State<BreezDropdownButton<T>> with WidgetsBindingObserver {
  int? _selectedIndex;
  ...
  void _handleTap() {
    ...
    Future.delayed(const Duration(milliseconds: 400), () {
      ...
      Navigator.push<_DropdownRouteResult<T>>(context, _dropdownRoute!)
