...
class QrCodeDialog extends StatefulWidget {
  ...
  const QrCodeDialog(
      this.context, this._invoice, this._onFinish);
                      ...
                      Row(
                                  children: <Widget>[
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        ShareExtend.share(
                                            "lightning:" + widget._invoice.bolt11,
                                            "text");
                                      },
                                    ),
                                    IconButton(
